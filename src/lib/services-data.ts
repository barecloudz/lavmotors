...
export const services: Service[] = [
  {
    ...
    shortDescription:
      "Official NC inspection station. Walk-ins welcome — most done in under 30 minutes.",
    price: "$13.60",
    highlight: true,
    image: null,
    pas: {
    ...
    howItHappens:
      "NC inspectors check over a dozen systems: brake condition and stopping power, tire tread depth (minimum 2/32\" — that's the penny test), all exterior lighting, windshield condition, window tint opacity, horn, wipers, seat belts, and for vehicles in certain counties, emissions via an OBD-II scan. A single failed item means you walk away without a sticker. Brakes and tires are the most common culprits — they wear gradually and most people don't notice until an inspector flags it. A check engine light will also fail emissions in participating NC counties, even if the car runs fine.",
    howWeFix:
      "We run through the full NC inspection checklist top to bottom. If you pass, you get your sticker and you're done. If something fails — worn brake pads, a burnt-out light, low tread depth — we'll show you exactly what the issue is and give you a straightforward quote to fix it. Most common inspection failures are things we can repair the same day so you can get your sticker and be on your way without a second trip.",
    included: [
    ...
    whyUs: [
      ...
      "Fast turnaround, usually 20–30 minutes",
    ...
    faq: [
      {
        ...
        answer:
          "No appointment needed. Drive in during business hours and we'll get you taken care of — usually in 20–30 minutes.",
      },
      {
  ...
  },
  {
    ...
    howItHappens:
      "Engine combustion produces byproducts — carbon, moisture, metal particles — that mix with your oil over time. Fresh oil handles this, but as it ages it breaks down and can no longer suspend those contaminants. They clump together into sludge. Heat accelerates this process dramatically: for every 18°F increase in temperature, the oxidation rate of oil roughly doubles. In an NC summer, your engine compartment can reach 200°F or more. Skipping an oil change in that environment compresses months of degradation into weeks.",
    howWeFix:
    ...
    faq: [
      {
        ...
        answer:
          "It depends on your vehicle and oil type. Most modern cars using full synthetic go 5,000–7,500 miles between changes. Check your owner's manual, or ask us — we'll tell you what your specific car actually needs.",
      },
      {
  ...
  },
  {
    ...
    whyUs: [
      ...
      "We show you the before/after data so you know exactly what was done",
  ...
  },
  {
    ...
    pas: {
      ...
      solution:
        "We inspect every component of your brake system — pads, rotors, calipers, and brake fluid — and give you a straight answer about what needs to be done now and what can wait. No pressure, no manufactured urgency. If we find something serious, we'll show you. If you've got life left in your brakes, we'll tell you that too.",
    },
    howItHappens:
      "Brake pads have a friction material that gradually wears away every time you stop. Most pads last 30,000–50,000 miles depending on how and where you drive — city driving and mountain roads are harder on brakes than highway miles. As pads wear thin, they lose stopping power and heat up more than they should. Repeated heat cycles warp rotors (causing that pulsing vibration when you brake) and degrade brake fluid — brake fluid absorbs moisture over time, which lowers its boiling point and creates soft, spongy pedal feel. Rust is a factor too: NC humidity corrodes brake lines and caliper slides, causing uneven wear and reduced performance.",
    howWeFix:
      "We start with a full brake inspection: measure pad thickness, check rotor condition for warping and wear, inspect calipers for sticking or leaking, and test brake fluid for moisture contamination. From there we give you a clear quote. Brake pad replacement is the most common service — we can usually complete it same day. If rotors need resurfacing or replacement, we handle that too. If the brake fluid is contaminated, a flush takes about an hour and makes a real difference in pedal feel and fade resistance.",
    included: [
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          "Typically 30,000–50,000 miles, but it varies a lot based on driving habits and conditions. City driving, mountain roads, and heavy vehicles all wear pads faster.",
      },
    ],
  },
  {
    ...
    howItHappens:
      "Your car's AC works by cycling refrigerant through a closed loop — compressor, condenser, expansion valve, evaporator. Refrigerant absorbs heat from inside the cabin and releases it outside. The most common reason AC stops blowing cold is a refrigerant leak: rubber seals, O-rings, and hose connections degrade from constant heat cycling and vibration, developing small gaps that let refrigerant slowly escape. NC's heat and humidity push AC systems harder than drier climates — your compressor runs nearly non-stop from May through September, stressing every component in the system. A compressor that's working that hard, in that heat, wears out faster.",
    howWeFix:
  ...
  },
  {
    ...
    pas: {
      hook: "You found a used car online. Good price, reasonable miles, clean photos. The seller seems straightforward. You take it for a drive — it feels fine. You're ready to buy.",
      agitate:
  ...
  },
  {
    ...
    pas: {
      ...
      agitate:
        "Here's the problem with a basic code reader: it tells you where the computer flagged something — not what actually caused it. A random misfire code could be a $15 spark plug or a $1,500 fuel injector issue. Replacing the wrong part doesn't make the check engine light go away. It just costs you money and still leaves you with the problem. Meanwhile, some check engine light causes are urgent — a flashing check engine light means stop driving — and others are minor sensor issues. Not being able to tell the difference means either you panic and overspend, or you ignore something that's about to become expensive.",
      solution:
        "Our professional diagnostic equipment does things a consumer code reader can't: it reads every stored and pending code, captures the live sensor data your car was reading at the moment the problem triggered, and gives our technicians what they need to identify the actual root cause. Most diagnostics take under an hour, and we walk you through what we found in plain language — no jargon, no pressure.",
    },
    howItHappens:
      "Modern vehicles have hundreds of sensors monitoring engine performance, emissions, transmission, and other systems. When a sensor reading falls outside the normal range, the car's computer (ECU) stores a diagnostic trouble code and lights the check engine light. The code identifies the system where the problem was detected — not always the exact part that failed. A single root problem can trigger multiple codes at once, which is why seeing several codes doesn't always mean several separate failures. Cheap OBD-II readers only retrieve the surface-level codes. They miss manufacturer-specific codes, pending codes, and the live data that shows what conditions caused the fault.",
    howWeFix:
      "We connect professional-grade scan equipment that reads all stored codes, pending codes, and freeze-frame data — the sensor values recorded at the exact moment the fault occurred. From there, our technicians use live data monitoring and targeted tests (fuel pressure tests, compression tests, ignition coil resistance tests, etc.) to narrow down the actual cause rather than guessing. Once we know what's wrong, we'll give you a clear repair quote. If you proceed with the repair here, we apply the diagnostic fee toward your bill.",
    included: [
